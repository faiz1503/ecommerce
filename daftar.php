                        ...
                        <table border="0" width="700">
                          ...
                          <li>
                            <label>
                              ...
                              *) Alamat pengiriman harus di isi lengkap, termasuk kota/kabupaten dan kode posnya.                            </label>
                          </li>                          </td>
                          </tr>
                          ...
                          <li>
                           ...
                           <tr><td valign=top>Kota Tujuan</td><td> :  
                              <select name='kota'>
                              <p align='center'><option value=0 selected>  - Pilih Kota -  </option></p>
                              <?php
                              $tampil=mysql_query("SELECT * FROM kota ORDER BY nama_kota");
                              while($r=mysql_fetch_array($tampil)){
                                 echo "<option value=$r[id_kota]>$r[nama_kota], Ongkos Kirim Rp.$r[ongkos_kirim]</option>";
                              }
							  ?>
                          </select> <br /><br />*)  Apabila tidak terdapat nama kota tujuan Anda, pilih <b>Lainnya</b></td></tr>
                                <tr>
                                  <td>&nbsp;</td>
                           ...
                           <input type="reset" onclick="alert('Apa anda yakin ingin menghapus inputan ?'); return false;"value="Delete Data">
						</td></tr>
                          </table>
                        </ul>
