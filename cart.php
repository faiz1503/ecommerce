      ...
      ?>    
        <table>
          ...
          <?php echo "$no";  ?>
			...
			?>
              <span class="currency">Rp.</span><span class="value"><?php echo "$hargadisc"; ?></span>
            
            </td>
            <td class="price dark">
            
              <span class="currency">Rp.</span><span class="value"><?php echo "$subtotal_rp"; ?></span>
            
            </td>
            <td class="price"><?php echo"<a href='aksi.php?module=keranjang&act=hapus&id=$r[id_orders_temp]'>Hapus</a>"; ?></td>
          </tr>
        <?php
		$no++;
		  }
