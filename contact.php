      ...
      <div role="main" class="container contact">        
        <div class="row">
          ...
          <div class="span5">
            ...
            <form action="road_way_under_construction/index.html" method="post" class="clearfix">
              <label>
              ...
              <br />
              <label>
               (masukkan kode di atas) <input class="text-input" type="text" name="kode" size="10" maxlength="6"/>
              </label>
        ...
        <div class="row top-spacing">
          ...
          <div class="span6 offset1">
            ...
            <p>
              Kecamatan Bukit Raya, Tangkerang Utara, Indonesia
            </p>
            
            <ul class="rr info clearfix">
              <li>
                Phone: <span class="val">081266480614</span>
              </li>
               <li>
                Email: <span class="val">mail@OnlenShop.com</span>
              </li>            
            </ul>
