...
<body onload="MM_controlSound('play','document.CS1449034813158','Radioactive (8 Bit Remix Cover Version) [Tribute to Imagine Dragons] - 8 Bit Universe_Zjgst_cWtrs_youtube.mp3')">
    ...
    <div class="row">
      <div class="span12">
        <ul class="rr slider" id="main-slider">
          <li class="slide-1">
            <div class="slide">
              <figure> <img src="img/ph/ph-home-banner-1.png" alt=""/> </figure>
              <div class="content-wrapper">
                <div class="content">
                  <h1>Koleksi Kemeja</h1>
                  <p> Untuk mendukung penampilan santai, fashionable, serta dinamis. Temukan koleksi berbagai macam kemeja yang keren sesuai penampilan yang anda inginkan. </p>
                </div>
              </div>
            </div>
          </li>
          <li class="slide-2 current">
            <div class="slide">
              <figure> <img src="img/ph/ph-home-banner-2.png" alt=""/> </figure>
              <div class="content-wrapper">
                <div class="content">
                  <h1>Aneka Kaos</h1>
                  <p> Tampil Elegan dan menawan dan fashionable adalah idaman setiap pria. Kami sajikan koleksi-koleksi kaos yang sesuai keinginan anda. </p>
                </div>
              </div>
            </div>
          </li>
          <li class="slide-3">
            <div class="slide">
              <figure> <img src="img/ph/ph-home-banner-3.png" alt=""/> </figure>
              <div class="content-wrapper">
                <div class="content">
                  <h1>Koleksi Jeans</h1>
                  <p> Temukan koleksi jeans dengan berbagai macam model dan warna untuk mendukung penampilan anda dimanapun dan kapanpun, yang elegan tampil berani dan berbeda. </p>
                </div>
              </div>
            </div>
          </li>
          <li class="slide-4">
            <div class="slide">
              <figure> <img src="img/ph/ph-home-banner-4.png" alt=""/> </figure>
              <div class="content-wrapper">
                <div class="content">
                  <h1>Aksesoris Lainnya</h1>
                  <p> Koleksi perlengkapan pria, dengan berbagai macam pilihan warna yang sesuai dengan fashion style terkini. </p>
                </div>
              </div>
            </div>
          </li>
          ...
          <div class="span12">
            <ul class="rr slider-menu" id="main-slider-menu">
              <li class="span3 alpha25 current">
                ...
                <div class="button" id="open-slide-1"> <span class="splitter">Splitter</span> Koleksi Kemeja 2013 </div>
              </li>
              <li class="span3 alpha25">
                <div class="triangle ir">Triangle</div>
                <div class="button" id="open-slide-2"> <span class="splitter">Splitter</span> Aneka Kaos </div>
              </li>
              <li class="span3 alpha25">
                <div class="triangle ir">Triangle</div>
                <div class="button" id="open-slide-3"> <span class="splitter">Splitter</span> Koleksi Jeans </div>
              </li>
              <li class="span3 alpha25">
                <div class="triangle ir">Triangle</div>
                <div class="button" id="open-slide-4"> <span class="splitter">Splitter</span> Aksesoris Lainnya <span class="splitter secondary">Splitter</span> </div>
              </li>
            </ul>
          </div>
        </div>
...
<div role="main" class="homepage container">
  ...
  <ul class="row-fluid clearfix rr popular-products grid-display" style="background:#FFF">
    <?php
            $q=mysql_query("select * from produk where status<>'featured' LIMIT 12");
